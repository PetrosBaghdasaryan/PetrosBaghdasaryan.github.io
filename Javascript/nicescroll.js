!function(e) {
    ...
    var g = window.MutationObserver || window.WebKitMutationObserver || !1
      ...
      , b = function(e, o) {
        ...
        this.delayed = function(e, o, t, r) {
            ...
            void (i && i.last + t > n && !i.tt ? v.delaylist[e] = {
                last: n + t,
        ...
        : this.notifyScrollEvent = function(e, o) {}
        ,
        ...
        this.init = function() {
            ...
            function o(e) {
                ...
                S.isios && v.haswrapper && (v.css(c(o.body), {
                    "-webkit-transform": "translate3d(0,0,0)"
                }),
                console.log(1)),
                "contentWindow"in this ? v.bind(this.contentWindow, "scroll", v.onscroll) : v.bind(o, "scroll", v.onscroll),
                v.opt.enablemousewheel && v.bind(o, "mousewheel", v.onmousewheel),
                v.opt.enablekeyboard && v.bind(o, S.isopera ? "keypress" : "keydown", v.onkeypress),
                (S.cantouch || v.opt.touchbehavior) && (v.bind(o, "mousedown", v.ontouchstart),
                v.bind(o, "mousemove", function(e) {
                    v.ontouchmove(e, !0)
                }),
                v.opt.grabcursorenabled && S.cursorgrabvalue && v.css(c(o.body), {
                    cursor: S.cursorgrabvalue
                })),
                v.bind(o, "mouseup", v.ontouchend),
                v.zoom && (v.opt.dblclickzoom && v.bind(o, "dblclick", v.doZoom),
                v.ongesturezoom && v.bind(o, "gestureend", v.ongesturezoom))
            }
            if (v.saved.css = [],
            S.isie7mobile)
                return !0;
            ...
            v.zindex = "auto",
            v.ispage || "auto" != v.opt.zindex ? v.zindex = v.opt.zindex : v.zindex = a() || "auto",
            ...
            !v.ispage || !S.cantouch && !S.isieold && !S.isie9mobile) {
                ...
                S.isie9mobile) {
                    v.scrollmom = new x(v),
                    v.onmangotouch = function(e) {
                        var o = v.getScrollTop()
                          , t = v.getScrollLeft();
                        if (o == v.scrollmom.lastscrolly && t == v.scrollmom.lastscrollx)
                            return !0;
                        var r = o - v.mangotouch.sy
                          , i = t - v.mangotouch.sx
                          , n = Math.round(Math.sqrt(Math.pow(i, 2) + Math.pow(r, 2)));
                        if (0 != n) {
                            var s = 0 > r ? -1 : 1
                              , l = 0 > i ? -1 : 1
                              , a = +new Date;
                            if (v.mangotouch.lazy && clearTimeout(v.mangotouch.lazy),
                            a - v.mangotouch.tm > 80 || v.mangotouch.dry != s || v.mangotouch.drx != l)
                                v.scrollmom.stop(),
                                v.scrollmom.reset(t, o),
                                v.mangotouch.sy = o,
                                v.mangotouch.ly = o,
                                v.mangotouch.sx = t,
                                v.mangotouch.lx = t,
                                ...
                                v.scrollmom.stop(),
                                v.scrollmom.update(v.mangotouch.sx - i, v.mangotouch.sy - r);
                                a - v.mangotouch.tm;
                                v.mangotouch.tm = a;
                                var c = Math.max(Math.abs(v.mangotouch.ly - o), Math.abs(v.mangotouch.lx - t));
                                v.mangotouch.ly = o,
                                v.mangotouch.lx = t,
                                c > 2 && (v.mangotouch.lazy = setTimeout(function() {
                                    v.mangotouch.lazy = !1,
                                    v.mangotouch.dry = 0,
                                    v.mangotouch.drx = 0,
                                    v.mangotouch.tm = 0,
                        ...
                        v.ontouchstart = function(e) {
                            ...
                            if (!v.locked) {
                                ...
                                v.ispage || !v.opt.directionlockdeadzone)
                                    ...
                                    !v.rail.scrollable && v.railh.scrollable ? v.rail.drag.ck = l > 0 ? "v" : !1 : v.rail.scrollable && !v.railh.scrollable ? v.rail.drag.ck = a > 0 ? "h" : !1 : v.rail.drag.ck = !1,
        ...
        this.doScrollPos = function(e, o, t) {
            ...
            if (t && 1 >= t && (c *= t),
            c > 0 ? v.bzscroll = v.bzscroll ? v.bzscroll.update(a, c) : new BezierClass(l,a,c,0,1,0,1) : v.bzscroll = !1,
            !v.timer) {
        ...
        this.doScrollBy = function(e, o) {
            ...
            py = v.getScrollTop(!0),
            0 > t && py <= 0 ? v.noticeCursor() : t > v.page.maxh && py >= v.page.maxh ? (v.checkContentSize(),
        ...
        this.doScrollLeftBy = function(e, o) {
            ...
            0 > t && px <= 0 ? v.noticeCursor() : t > v.page.maxw && px >= v.page.maxw ? v.noticeCursor() : void v.doScrollLeft(t)
        }
        ,
    ...
    c.cssHooks.pageXOffset = {
        get: function(e, o, t) {
            var r = c.data(e, "__nicescroll") || !1;
            return r && r.ishwscroll ? r.getScrollLeft() : z.call(e)
        },
        set: function(e, o) {
            var t = c.data(e, "__nicescroll") || !1;
